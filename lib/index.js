...
module.exports = {
	...
	targets: {
		...
		// added javascripts
		'./assets/linker/js/dependencies/socket.io.js': { template: 'assets/linker/js/dependencies/socket.io.js' },
		'./assets/linker/js/dependencies/sails.io.js': { template: 'assets/linker/js/dependencies/sails.io.js' },
		'./assets/linker/js/dependencies/sails.io.backbone.js': { template: 'assets/linker/js/dependencies/sails.io.backbone.js' },
		'./assets/linker/js/dependencies/connect.js': { template: 'assets/linker/js/dependencies/connect.js' },
		...
		'./assets/linker/js/models': { folder: {} },
		'./assets/linker/js/models/Session.js': { template: 'assets/linker/js/models/Session.js' },

		// added templates
		'./assets/linker/templates/App.html': { template: 'assets/linker/templates/App.html' },

		// starter HTML container page
